...
object Constants {
    ...
    const val PENDING_INTENT_REQUEST_ALARM_RINGING_ACTIVITY = 2003
    const val PENDING_INTENT_REQUEST_ALARM_RINGING_DISMISS = 2004
    const val PENDING_INTENT_REQUEST_ALARM_ACTION = 2005
    ...
    const val PENDING_INTENT_REQUEST_APP_HOME = 2011
    const val PENDING_INTENT_REQUEST_EXACT_ALARM_SETTINGS = 2012
    const val PENDING_INTENT_REQUEST_APP_SETTINGS = 2013
