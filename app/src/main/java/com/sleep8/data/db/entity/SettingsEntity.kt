...
data class SettingsEntity(
    ...
    @ColumnInfo(name = "night_start") val nightStart: String = "21:00",
    @ColumnInfo(name = "night_end") val nightEnd: String = "04:00",
    ...
    @ColumnInfo(name = "auto_arm_start") val autoArmStart: String = "20:00",
    @ColumnInfo(name = "auto_arm_end") val autoArmEnd: String = "04:00"
)
